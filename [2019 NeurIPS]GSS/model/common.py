...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes, nf, bias):
        ...
        self.linear = nn.Linear(nf * 128 * block.expansion, num_classes, bias=bias)
    ...
    def forward(self, x):
        ...
        out = relu(self.bn1(self.conv1(x.view(bsz, 3, 128, 128))))
        out = self.layer1(out)
        out = self.layer2(out)
        out = self.layer3(out)
        out = self.layer4(out)
...
# def ResNet18(nclasses, nf=5, bias=True):
